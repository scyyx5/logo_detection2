...
from PyQt5.QtWidgets import QWidget, QDesktopWidget, QApplication, QPushButton, QToolTip, QHBoxLayout, QVBoxLayout, \
    QLabel, QFileDialog
...
class MainWindow(QWidget):
    def __init__(self):
        ...
        model = tf.keras.models.load_model('ResNet50V2Logos.h5')
    ...
    def loadData(self):
        self.pred_images = pd.read_csv('pred_data_all_rn50v2.csv').values
        self.image_paths = pd.read_csv('img_paths_all.csv').values.flatten()
